...
const Testimonials = () => {
  return (
    <motion.div 
      ...
      viewport={{once:true}}
    className='container mx-auto py-10 lg:px-32 w-fulll overflow-hidden' id='Testimonials'>
      ...
      <p className='text-center text-gray-500 mb-12 max-w-80 mx-auto'>Real Stories from Those who Found Homw wwith Us</p>
